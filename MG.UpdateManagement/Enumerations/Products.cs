...
namespace MG.UpdateManagement.Enumerations
{
    public enum UMProducts : int
    {
        ...
        [AllowedPlatforms(new[] { "x64", "Itanium" })]
        [FutureReleases(null)]
        [Category("Server")]
        Server2008R2 = 2
        ,
        ...
        [Base("Windows 10")]
        [AllowedPlatforms(new[] { "x64", "x86", "ARM" })]
        [FutureReleases(null)]
        [Category("Desktop")]
        Win1607 = 9
        ,
        ...
        [Base("Office 2010")]
        [AllowedPlatforms(new[] { "32-Bit", "64-Bit" })]
        [FutureReleases(null)]
        [Category("Office")]
        Office2010 = 13
        ,
